...
[![CMake package](https://img.shields.io/github/v/tag/AB-KeyNub/KeyNub-SDK?filter=v*&label=CMake%20package)](NATIVES.md)
...
| Delphi / Free Pascal | [`bindings/delphi`](bindings/delphi) | [`samples/delphi`](samples/delphi) | [![Lazarus OPM](https://img.shields.io/github/v/tag/AB-KeyNub/KeyNub-SDK?filter=v*&label=Lazarus%20OPM)](https://packages.lazarus-ide.org/) |
...
| Swift | [`bindings/swift`](bindings/swift) — `KeyNubLicDongle`, SwiftPM package at the repository root | [`samples/swift`](samples/swift) | [![Swift Package Index](https://img.shields.io/github/v/tag/AB-KeyNub/KeyNub-SDK?filter=v*&label=Swift%20Package%20Index)](https://swiftpackageindex.com/AB-KeyNub/KeyNub-SDK) |
